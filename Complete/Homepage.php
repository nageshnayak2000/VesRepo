...
<body>  
    ...
    <div class="container">
      ...
      <section class="container1">
        <button data-hover="click me!"><div>View Profile</div></button>
      </section>
      <section class="container2">
        <button onclick="location.href='registration.php'" data-hover="click me!"><div>Register Here</div></button>
      </section>
      <section class="container3">
        <button data-hover="click me!"><div>Search Profile</div></button>
      </section>
